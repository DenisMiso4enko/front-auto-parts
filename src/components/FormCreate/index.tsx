...
export function FormCreate() {
  ...
  const handlerOnCreatePost = (event: any) => {
    ...
    const formInfo = {
      ...
      imagesUrl: event.target[10].value,
  ...
  return (
      ...
      <Form.Group as={Row} className="mb-6 custom-group" controlId="formCreate">
        <Form.Label column sm={2}>
          Марка*
        </Form.Label>
        <Col sm={10}>
          <Form.Control type="text" placeholder="Введите марку авто" required />
        </Col>
      </Form.Group>

      <Form.Group as={Row} className="mb-3 custom-group" controlId="formCreate">
        <Form.Label column sm={2}>
          Модель*
        </Form.Label>
        <Col sm={10}>
          <Form.Control type="text" placeholder="Введите модель авто" required />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3 custom-group" controlId="formCreate">
        ...
        <Col sm={10}>
          <Form.Control type="text" placeholder="Введите год выпуска авто" required/>
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3 custom-group" controlId="formCreate">
        ...
        <Col sm={10}>
          <Form.Control type="text" placeholder="Введите тип кузова" />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3 custom-group" controlId="formCreate">
        ...
        <Col sm={10}>
          <Form.Control type="text" placeholder="Введите название запчасти" required />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3 custom-group" controlId="formCreate">
        ...
        <Col sm={10}>
          <Form.Control type="text" placeholder="Выберите фото" />
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3 custom-group" controlId="formCreate">
        ...
        <Col sm={10}>
          <Form.Control type="textarea" placeholder="Напишите описание запчасти" style={{ minHeight: '100px' }}/>
        </Col>
      </Form.Group>
